    ...
    return (
        <div className='navbar'>
            ...
            <ul ref={menuRef} className="nav-menu" >
                ...
                <li><AnchorLink className='anchor-link' href='#home'><p onClick={() => setManu("home")}>Home</p></AnchorLink>{menu == 'home' ? <img src={underline} alt='' /> : <></>}</li>
                <li><AnchorLink className='anchor-link' offset={50} href='#about'><p onClick={() => setManu("about")}>About Me</p></AnchorLink>{menu == 'about' ? <img src={underline} alt='' /> : <></>}</li>
